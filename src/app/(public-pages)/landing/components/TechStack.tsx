...
const stackList = [
    ...
    },
    {
        id: 'tailwind',
        title: 'TailwindCSS',
        description: 'A utility-first CSS framework that allows for rapid, responsive design.'
    },
    {
        id: 'typescript',
        title: 'TypeScript',
        description: 'Static typing for improved code quality and development efficiency.'
    },
    {
        id: 'nextjs',
        title: 'Next.js',
    ...
    },
    {
        ...
        description: 'Efficient form management with minimal performance impact.' 
    },
    {
        id: 'zod',
        title: 'Zod',
        description: 'Schema validation made easy with TypeScript-first design.'
    },
    {
        id: 'zustand',
        title: 'Zustand',
        description: 'A lightweight state management solution for managing complex application states.'
    },
    {
        id: 'next-auth',
        title: 'Auth.js',
        description: 'Auth.js is a Web API-based library for simple, secure, and extensible authentication.'
    }
]
